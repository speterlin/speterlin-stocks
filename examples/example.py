...
portfolio_zr_test = {
    'constants': {'type': 'zr', 'up_down_move': 2, 'days': 10, 'sl': -0.15, 'tsl_a': 0.05, 'tsl_p': -0.0125, 'usd_invest': 1000, 'usd_invest_min': 100, 'buy_date_gtrends_15d': False, 'end_day_open_positions_gtrends_15d': False, 'end_day_open_positions_fmp_24h_vol': False, 'start_balance': {'usd': 10000}, 'start_day': start_day.strftime('%Y-%m-%d')},
