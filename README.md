...
portfolios = {
  ...
  'mmtv': 'Momentum Mean Trading Volume - Buy or sell the ticker if the Trading Volume is greater than or less than the Mean Trading Volume over interval days',
  ...
  'mm': 'Momentum Move - Buy the ticker ranked by price change over the past interval days (meant for long-term 3-12 months ~90-~365days interval days)',
